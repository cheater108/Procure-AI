...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=even]:duration-500 data-[state=closed]:duration-300",
  {
    variants: {
      side: {
