      ...
      <section className="container mx-auto px-4 py-20 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
            Automate your RFP process, reduce costs, and make data-driven
            decisions with our AI-powered procurement platform.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Our platform leverages cutting-edge AI to revolutionize your
              procurement process.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Generate comprehensive RFPs in minutes with AI assistance.",
              },
              {
                title: "Vendor Matching",
                description:
                  "Find the perfect vendors using our intelligent matching algorithm.",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Streamline your contract lifecycle with automated tracking.",
              },
              {
                title: "Cost Optimization",
                description:
                  "Identify cost-saving opportunities with AI-powered insights.",
              },
              {
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto bg-linear-to-r from-primary/5 to-primary/10 p-8 rounded-2xl">
            ...
            <p className="text-muted-foreground mb-6">
              Join leading companies that trust ProcureAI for their procurement
              needs.
            </p>
            <Button size="lg" className="gap-2">
              Start Free Trial
